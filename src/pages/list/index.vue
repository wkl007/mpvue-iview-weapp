<template>
  <div>
    ...
    <i-panel class="cell-panel-demo">
      <i-cell title="跳转到首页" is-link url="/pages/iview_dashboard/main"></i-cell>
    </i-panel>
    ...
    <i-panel class="cell-panel-demo" title="cell 组">
      <i-cell-group>
        <i-cell title="只显示箭头" is-link></i-cell>
        <i-cell title="跳转到首页" is-link url="/pages/iview_dashboard/main"></i-cell>
        <i-cell title="只有 footer 点击有效" is-link url="/pages/iview_dashboard/main" only-tap-footer></i-cell>
        <div v-if="switch1">
          <i-cell title="单行列表" label="附加描述" value="详细信息"></i-cell>
          <i-cell title="表单">
